...
public class ThreeLayerManager : LayerManager
{
    void Start()
    {
        ...
        {
            btn.onClick.AddListener(() => Scenemanager.Instance.ToScene(4));
        }
        restart.onClick.AddListener(() => Scenemanager.Instance.ToScene(3));
