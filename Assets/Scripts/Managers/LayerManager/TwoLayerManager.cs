...
public class TwoLayerManager : LayerManager
{
    void Start()
    {
        ...
        {
            btn.onClick.AddListener(() => Scenemanager.Instance.ToScene(3));
        }
        restart.onClick.AddListener(() => Scenemanager.Instance.ToScene(2));
